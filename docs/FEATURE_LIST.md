...
> 최종 업데이트: 2026-04-30 (인수인계 시점)
> 총 79개 페이지 | 38개 서버 액션 (admin/ 9개 + 루트 24개 + comprehensive-exam/ 5개) | ~86개 공유 컴포넌트/라이브러리
>
> ※ 이전 105+ → 38로 감소한 것은 카운트 기준 변경 (이전: export 함수 단위 카운트, 현재: 파일 단위 카운트). 실제 기능 감소 아님.
>
> 이후 추가/변경된 주요 기능 (2026-03~2026-04):
> - 작문(Writing) 시스템: writing_exercises 테이블 + page (Beta)
> - 코딩 학습 시스템: coding_learning 테이블 + page (Beta)
> - 일본어 학습 UI 재구성
