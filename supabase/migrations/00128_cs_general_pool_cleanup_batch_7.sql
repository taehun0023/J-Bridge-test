-- General pool cleanup batch 7.
-- Purpose:
-- 1. close the remaining OS medium floor gap
-- 2. reduce remaining null-state rows in computer_architecture
-- 3. reduce remaining null-state rows in network
