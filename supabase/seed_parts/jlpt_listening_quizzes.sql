...
BEGIN
  q_id := gen_random_uuid();
  INSERT INTO quiz_questions (id, quiz_id, question_type, question_text, explanation, points, sort_order, difficulty, question_category)
  VALUES (q_id, 'd0000001-0000-0000-0000-000000000001', 'multiple_choice', E'次の文を聴いて、質問に答えてください。\n\nアナウンサー：今日の東京の天気は晴れです。気温は二十五度です。明日は曇りで、午後から雨が降るでしょう。傘を持って出かけてください。\n\n質問：明日の天気はどうですか。', E'「明日は曇りで、午後から雨が降るでしょう」と言っています。明日は曇りのち雨です。', 1, 6, 'N5', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '晴れのち曇りで涼しい', FALSE, 1),
    (gen_random_uuid(), q_id, '曇りで午後から雨', TRUE, 2),
    (gen_random_uuid(), q_id, '朝から一日中雨が続く', FALSE, 3),
    (gen_random_uuid(), q_id, '晴れて午後から風が強い', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '10時には別の約束がすでに入っていたから', FALSE, 1),
    (gen_random_uuid(), q_id, '公園が10時にはまだ開かないと思ったから', FALSE, 2),
    (gen_random_uuid(), q_id, '10時は早すぎると感じて時間を変えたかったから', TRUE, 3),
    (gen_random_uuid(), q_id, '土曜日は用事があり出かけたくなかったから', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '新幹線で行く', FALSE, 1),
    (gen_random_uuid(), q_id, '飛行機で行く', FALSE, 2),
    (gen_random_uuid(), q_id, '普通電車で行く', FALSE, 3),
...
BEGIN
  q_id := gen_random_uuid();
  INSERT INTO quiz_questions (id, quiz_id, question_type, question_text, explanation, points, sort_order, difficulty, question_category)
  VALUES (q_id, 'd0000002-0000-0000-0000-000000000002', 'multiple_choice', E'次の文を聴いて、質問に答えてください。\n\nアナウンス：このバスは東京駅行きです。次は「中央公園前」です。本日は祝日ダイヤで運行しております。通常より本数が少なくなっておりますので、ご注意ください。\n\n質問：今日のバスについて正しいものはどれですか。', E'「本日は祝日ダイヤで運行しております。通常より本数が少なくなっております」と言っているので、通常より運行本数が少ないです。', 1, 6, 'N4', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '普段よりも運行本数が多くなっている', FALSE, 1),
    (gen_random_uuid(), q_id, '悪天候のため今日は全便が運休になった', FALSE, 2),
    (gen_random_uuid(), q_id, '祝日ダイヤで運行本数が少ない', TRUE, 3),
    (gen_random_uuid(), q_id, '点検のため東京駅までは行かない', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '自分が何かを言うときに使う', FALSE, 1),
    (gen_random_uuid(), q_id, '親しい友達に話しかけるとき', FALSE, 2),
    (gen_random_uuid(), q_id, '相手が言ったことを表すとき', TRUE, 3),
    (gen_random_uuid(), q_id, '心の中で独り言を言うとき', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '上の階の住民に管理人が直接注意して改善を求める', FALSE, 1),
    (gen_random_uuid(), q_id, '全体のお知らせとして夜間騒音の注意事項を掲示する', TRUE, 2),
    (gen_random_uuid(), q_id, '警察に通報して夜間の騒音についての調査を依頼する', FALSE, 3),
    (gen_random_uuid(), q_id, '高橋さんに別の静かな部屋への引っ越しを勧める', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '物理的に離れた場所にいるように感じるという意味', FALSE, 1),
    (gen_random_uuid(), q_id, '友達に敬語を使うとよそよそしくなるという意味', TRUE, 2),
    (gen_random_uuid(), q_id, '友達と会う機会がだんだん減っていくという意味', FALSE, 3),
    (gen_random_uuid(), q_id, '敬語が難しすぎて正しく使えないという意味', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '大きな地震が起きて建物が倒壊する危険がある', FALSE, 1),
    (gen_random_uuid(), q_id, '強い台風が接近していて外出はとても危険な状態だ', FALSE, 2),
    (gen_random_uuid(), q_id, '警報は出たが特に避難の必要性はまだないと判断された', FALSE, 3),
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '血圧が基準値より高い', FALSE, 1),
    (gen_random_uuid(), q_id, '血糖値がやや高めである', FALSE, 2),
    (gen_random_uuid(), q_id, 'コレステロール値が高い', TRUE, 3),
    (gen_random_uuid(), q_id, '肝機能に異常が見られた', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'そのまま中止で後日は未定', FALSE, 1),
    (gen_random_uuid(), q_id, '翌週の土曜日に延期される', FALSE, 2),
    (gen_random_uuid(), q_id, '体育館の中で縮小して行う', FALSE, 3),
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '管理費の値上げに関する提案', FALSE, 1),
    (gen_random_uuid(), q_id, '大規模修繕工事の実施計画', TRUE, 2),
    (gen_random_uuid(), q_id, '駐車場の拡張工事に関する報告', FALSE, 3),
    (gen_random_uuid(), q_id, 'エレベーターの更新に関する提案', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '調理器具と食材一式', FALSE, 1),
    (gen_random_uuid(), q_id, 'エプロンと三角巾', TRUE, 2),
    (gen_random_uuid(), q_id, 'レシピ本と筆記用具', FALSE, 3),
    (gen_random_uuid(), q_id, '包丁とまな板と菜箸', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '薬を処方するほど症状がひどくはないと判断したから', FALSE, 1),
    (gen_random_uuid(), q_id, '薬なしで生活習慣の改善でまず様子を見たいから', TRUE, 2),
    (gen_random_uuid(), q_id, '処方したい薬が今は在庫切れで手配できないから', FALSE, 3),
    (gen_random_uuid(), q_id, '田中さんが薬の副作用を心配して拒否をしたから', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '模擬店での食品の販売を全面的に中止しよう', FALSE, 1),
    (gen_random_uuid(), q_id, '販売する食品の種類と数量を大幅に減らそう', FALSE, 2),
    (gen_random_uuid(), q_id, '各出店にアレルギー表示を義務付けよう', TRUE, 3),
    (gen_random_uuid(), q_id, 'アレルギーのある児童は食品コーナーを避けよう', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '自動車による交通事故の件数が急激に増えている', FALSE, 1),
    (gen_random_uuid(), q_id, '自転車利用者が交通ルールを守らない現実がある', TRUE, 2),
    (gen_random_uuid(), q_id, '歩行者が関わる交通事故が最も多い割合を占める', FALSE, 3),
    (gen_random_uuid(), q_id, '最近になって交通ルールが大幅に改正された', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    ...
    (gen_random_uuid(), q_id, '急激な人口過密による周辺の生活環境の悪化', FALSE, 2),
    (gen_random_uuid(), q_id, '外国人観光客の急増に伴う地域全体の混雑', FALSE, 3),
    (gen_random_uuid(), q_id, '度重なる自然災害による被害からの復旧', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '画一的な教育から個別最適化された学びへの転換が遅れていること', FALSE, 1),
    (gen_random_uuid(), q_id, '学校施設の老朽化が進み安全性に深刻な問題が各地で生じていること', FALSE, 2),
    (gen_random_uuid(), q_id, '暗記偏重から脱却できず批判的思考力と創造性教育が不足していること', TRUE, 3),
    (gen_random_uuid(), q_id, '教員数が不足しており一人あたりの生徒数が多すぎて対応できないこと', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '大規模なショッピングモールを誘致して商業施設を大幅に拡充すること', FALSE, 1),
    (gen_random_uuid(), q_id, '大手メーカーの工場を誘致して地域の雇用を創出し税収を確保すること', FALSE, 2),
    (gen_random_uuid(), q_id, '温泉・伝統工芸・自然環境を組み合わせた体験型滞在プログラムの開発', TRUE, 3),
    (gen_random_uuid(), q_id, '高速道路や新幹線の駅を建設して都市部との交通の利便性を向上', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '教員の負担となっている部活動を全面的に廃止すべきだ', FALSE, 1),
    (gen_random_uuid(), q_id, '教員の数をもっと増やして一人あたりの負担を軽減すべきだ', FALSE, 2),
    (gen_random_uuid(), q_id, '教員の業務負担を減らさなければ教育改革は実現不可能だ', TRUE, 3),
    (gen_random_uuid(), q_id, '保護者が学校行事や教育活動にもっと積極的に参加すべきだ', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '多文化共生に関する法律と制度の抜本的な整備', FALSE, 1),
    (gen_random_uuid(), q_id, '外国人住民への日本語教育機会を大幅に拡充する', FALSE, 2),
    (gen_random_uuid(), q_id, '地域レベルの草の根の交流と日常的な接点の拡大', TRUE, 3),
    (gen_random_uuid(), q_id, '社会の安定のために外国人住民の受入人数を制限', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '会員の減少が進んでいる - 年会費の値上げで財源を確保する', FALSE, 1),
    (gen_random_uuid(), q_id, 'ボランティアが不足している - 有給の常勤職員を新たに採用する', FALSE, 2),
    (gen_random_uuid(), q_id, '活動資金の確保困難 - 企業協働とクラウドファンディングの活用', TRUE, 3),
    (gen_random_uuid(), q_id, '活動範囲が広すぎて手が回らない - 他地域のNPOと統合して効率化', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'コートとマフラー', FALSE, 1),
    (gen_random_uuid(), q_id, '帽子とマフラー', FALSE, 2),
    (gen_random_uuid(), q_id, 'コートと帽子', TRUE, 3),
    (gen_random_uuid(), q_id, 'マフラーと手袋', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'バスのほうが電車より安いから', FALSE, 1),
    (gen_random_uuid(), q_id, '駅が遠いのでバスが便利だから', TRUE, 2),
    (gen_random_uuid(), q_id, '電車の本数が少ないのが不便だから', FALSE, 3),
    (gen_random_uuid(), q_id, '歩くと時間がかかりすぎるから', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '病院に行って薬をもらう', FALSE, 1),
    (gen_random_uuid(), q_id, '先生に言って家に帰る', TRUE, 2),
    (gen_random_uuid(), q_id, '教室で少し休んでから勉強する', FALSE, 3),
    (gen_random_uuid(), q_id, '水を飲んでから授業に出る', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'ホラー系の映画', FALSE, 1),
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '学校の先生', FALSE, 1),
    (gen_random_uuid(), q_id, '病院勤務', TRUE, 2),
    (gen_random_uuid(), q_id, '会社員', FALSE, 3),
    (gen_random_uuid(), q_id, '大学の学生', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'おしゃれなマグカップ', FALSE, 1),
    (gen_random_uuid(), q_id, 'コーヒー豆のセット', TRUE, 2),
    (gen_random_uuid(), q_id, '手作りのバースデーケーキ', FALSE, 3),
    (gen_random_uuid(), q_id, '話題のベストセラー本', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '漢字の勉強をあきらめて会話に集中する', FALSE, 1),
    (gen_random_uuid(), q_id, '毎日少しずつ書いて1日10個から始める', TRUE, 2),
    (gen_random_uuid(), q_id, '漢字専門の塾に通って毎日集中的に学ぶ', FALSE, 3),
    (gen_random_uuid(), q_id, 'スマホのアプリを使って隙間時間に勉強する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '本をうっかりなくしてしまったから', FALSE, 1),
    (gen_random_uuid(), q_id, '本を少し汚してしまったから', TRUE, 2),
    (gen_random_uuid(), q_id, '約束の日に本を返し忘れたから', FALSE, 3),
    (gen_random_uuid(), q_id, '借りた本の感想を伝え忘れたから', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '仕事の内容がとても難しいこと', FALSE, 1),
    (gen_random_uuid(), q_id, '残業が多くて早く帰りたい', TRUE, 2),
    (gen_random_uuid(), q_id, '給料が低くてやる気が出ない', FALSE, 3),
    (gen_random_uuid(), q_id, '同僚との人間関係がよくない', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '日常会話の表現', FALSE, 1),
    (gen_random_uuid(), q_id, '敬語（尊敬語）', TRUE, 2),
    (gen_random_uuid(), q_id, '漢字の読み書き', FALSE, 3),
    (gen_random_uuid(), q_id, '正確な発音と抑揚', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '月曜日の午後', FALSE, 1),
    (gen_random_uuid(), q_id, '水曜日の午前', TRUE, 2),
    (gen_random_uuid(), q_id, '金曜日の夕方', FALSE, 3),
    (gen_random_uuid(), q_id, '木曜日の朝一', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'プレゼンテーション全体の構成と内容の正確さ', FALSE, 1),
    (gen_random_uuid(), q_id, 'グラフの色のコントラストとフォントの大きさ', TRUE, 2),
    (gen_random_uuid(), q_id, '使用しているデータの出典元と信頼性の確認', FALSE, 3),
    (gen_random_uuid(), q_id, 'スライドの枚数と発表時間の長さのバランス', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'フリーランスの開発者として将来的に独立すること', FALSE, 1),
    (gen_random_uuid(), q_id, 'PMとして国際プロジェクトをリードすること', TRUE, 2),
    (gen_random_uuid(), q_id, '自分でIT企業を立ち上げて将来的に起業すること', FALSE, 3),
    (gen_random_uuid(), q_id, '海外支社に転勤して現地で開発に携わること', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '教科書をもっとじっくり読み込む', FALSE, 1),
    (gen_random_uuid(), q_id, '実際にアプリを作ってみる', TRUE, 2),
    (gen_random_uuid(), q_id, 'プログラミング専門の塾に通う', FALSE, 3),
    (gen_random_uuid(), q_id, 'IT系の資格試験に挑戦してみる', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '条件がいい今のうちにすぐ転職する', FALSE, 1),
    (gen_random_uuid(), q_id, 'もう少し経験を積んでから転職する', TRUE, 2),
    (gen_random_uuid(), q_id, '今の会社に残って転職をあきらめる', FALSE, 3),
    (gen_random_uuid(), q_id, 'まずは副業から始めて様子を見る', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '激しい運動を避けること', FALSE, 1),
    (gen_random_uuid(), q_id, '夜9時以降食事をしない', TRUE, 2),
    (gen_random_uuid(), q_id, '早めに就寝して休む', FALSE, 3),
    (gen_random_uuid(), q_id, '水をたくさん飲んでおく', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '参加者全員が積極的に自分の意見を言う', FALSE, 1),
    (gen_random_uuid(), q_id, '事前に根回しして会議では確認だけする', TRUE, 2),
    (gen_random_uuid(), q_id, '議論が白熱して会議がとても長くなる', FALSE, 3),
    (gen_random_uuid(), q_id, '上司だけが発言して部下は黙っている', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'ロジックにバグがあるので修正が必要だ', FALSE, 1),
    (gen_random_uuid(), q_id, '変数名がわかりにくいので具体的にすべきだ', TRUE, 2),
    (gen_random_uuid(), q_id, 'コメントが不足していて処理の意図が不明だ', FALSE, 3),
    (gen_random_uuid(), q_id, 'インデントやコードの整形が統一されていない', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '手作業でコードを書く能力', FALSE, 1),
    (gen_random_uuid(), q_id, 'AIを扱い活用する能力', TRUE, 2),
    (gen_random_uuid(), q_id, 'AIに頼らず独力で開発する力', FALSE, 3),
    (gen_random_uuid(), q_id, 'チームをまとめる管理職の力', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'インフラのコストが高くなる', FALSE, 1),
    (gen_random_uuid(), q_id, 'サービス間通信の複雑さ', TRUE, 2),
    (gen_random_uuid(), q_id, '初期の開発速度が大幅に遅い', FALSE, 3),
    (gen_random_uuid(), q_id, '運用に必要な人員が不足する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '新しい人員を増やして業務量を分散する', FALSE, 1),
    (gen_random_uuid(), q_id, 'ノー残業デーの導入と不要な会議の削減', TRUE, 2),
    (gen_random_uuid(), q_id, '残業手当を増額して社員の不満を解消する', FALSE, 3),
    (gen_random_uuid(), q_id, 'リモートワークを導入して通勤時間を削減', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'リンクをクリックして内容を確認する', FALSE, 1),
    (gen_random_uuid(), q_id, '情報セキュリティ部門に報告する', TRUE, 2),
    (gen_random_uuid(), q_id, 'すぐに削除して何もしないでおく', FALSE, 3),
    (gen_random_uuid(), q_id, '確認のために同僚にメールを転送する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'QAチームの人員を増やして対応する', FALSE, 1),
    (gen_random_uuid(), q_id, 'CI/CDに自動テストを組み込む', TRUE, 2),
    (gen_random_uuid(), q_id, '手動テストの範囲と工数を拡大する', FALSE, 3),
    (gen_random_uuid(), q_id, 'リリースの周期を遅らせて確認する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '今のリリースに急いで追加する', FALSE, 1),
    (gen_random_uuid(), q_id, '次のフェーズで対応する', TRUE, 2),
    (gen_random_uuid(), q_id, 'スコープ外として正式に断る', FALSE, 3),
    (gen_random_uuid(), q_id, '別のチームに引き継いで対応する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '全体的な人件費を削減するため', FALSE, 1),
    (gen_random_uuid(), q_id, '意思決定の速度を上げるため', TRUE, 2),
    (gen_random_uuid(), q_id, '新しい社員の採用枠を増やすため', FALSE, 3),
    (gen_random_uuid(), q_id, '管理職のポストを新設するため', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'アプリケーションのソースコードを自動的に生成する', FALSE, 1),
    (gen_random_uuid(), q_id, '複数のコンテナを自動的に管理しスケーリングする', TRUE, 2),
    (gen_random_uuid(), q_id, 'データベースのバックアップと復元を自動化する', FALSE, 3),
    (gen_random_uuid(), q_id, 'ネットワークのセキュリティ設定を一元管理する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'アプリケーションサーバーを即座に再起動する', FALSE, 1),
    (gen_random_uuid(), q_id, 'サーバーの台数を増やす（スケールアウト）', TRUE, 2),
    (gen_random_uuid(), q_id, '問題のAPIへのリクエストを一時的に遮断する', FALSE, 3),
    (gen_random_uuid(), q_id, 'メンテナンス画面を表示してユーザーに案内する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '当面は残業を許可して業務量に対応する', FALSE, 1),
    (gen_random_uuid(), q_id, '業務の分担と優先度の低いタスクの後回し', TRUE, 2),
    (gen_random_uuid(), q_id, 'クライアントと交渉して納期を延長する', FALSE, 3),
    (gen_random_uuid(), q_id, '負荷の高いプロジェクトから一時的に外れる', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'インドの開発拠点に出張して現地で直接コミュニケーション', FALSE, 1),
    (gen_random_uuid(), q_id, '時差を考慮した会議時間の調整と英語のドキュメント作成', TRUE, 2),
    (gen_random_uuid(), q_id, '専門の通訳者を雇って全ての会議に同席してもらうこと', FALSE, 3),
    (gen_random_uuid(), q_id, 'チーム全員がヒンディー語を学んで現地語で対応すること', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '新しいシステムをゼロから構築する', FALSE, 1),
    (gen_random_uuid(), q_id, '現在のシステムを棚卸しする', TRUE, 2),
    (gen_random_uuid(), q_id, 'デジタル人材を大量に採用する', FALSE, 3),
    (gen_random_uuid(), q_id, '全てを外部の業者に委託する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '現在の給与水準に不満があるから', FALSE, 1),
    (gen_random_uuid(), q_id, 'Web系の開発に挑戦したいから', TRUE, 2),
    (gen_random_uuid(), q_id, '職場の人間関係に問題があるから', FALSE, 3),
    (gen_random_uuid(), q_id, '体調不良で働き続けるのが困難', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'リスクが高いのでAIの導入自体を見送るべきだ', FALSE, 1),
    (gen_random_uuid(), q_id, 'ツールとして活用し最終判断は人間がすべきだ', TRUE, 2),
    (gen_random_uuid(), q_id, '効率化のためにAIの判断に全て委ねるべきだ', FALSE, 3),
    (gen_random_uuid(), q_id, 'AI生成コードは品質が高くレビューは不要だ', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '従来のシステムより高速な処理が可能だ', FALSE, 1),
    (gen_random_uuid(), q_id, '中央管理者が不要な分散型の合意形成', TRUE, 2),
    (gen_random_uuid(), q_id, '記録されたデータを自由に削除・修正できる', FALSE, 3),
    (gen_random_uuid(), q_id, 'どんな組織でも無料で導入し利用できる', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '全体的に財務状況が悪化している', FALSE, 1),
    (gen_random_uuid(), q_id, '技術的負債が多く蓄積されている', TRUE, 2),
    (gen_random_uuid(), q_id, '独自のAI技術の開発力が不足している', FALSE, 3),
    (gen_random_uuid(), q_id, '優秀な技術者が次々と他社に流出した', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'バイアスの問題が解決するまでAI開発を中断する', FALSE, 1),
    (gen_random_uuid(), q_id, 'データの多様性確保と定期的な公平性監査', TRUE, 2),
    (gen_random_uuid(), q_id, 'バイアスを含む可能性のある学習データを削除する', FALSE, 3),
    (gen_random_uuid(), q_id, 'AIの判断過程を非公開にして批判を回避する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '利用者に対する制約が一切存在しない', FALSE, 1),
    (gen_random_uuid(), q_id, 'ソースコードの公開義務が発生し得る', TRUE, 2),
    (gen_random_uuid(), q_id, '営利目的での商業利用が全面的に禁止', FALSE, 3),
    (gen_random_uuid(), q_id, '利用にはライセンス料の支払いが必要', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '教科書に基づいた知識の正確な暗記と再現', FALSE, 1),
    (gen_random_uuid(), q_id, '実際の課題解決プロセスを通じた学習', TRUE, 2),
    (gen_random_uuid(), q_id, '試験での高得点を目標にした効率的な受験勉強', FALSE, 3),
    (gen_random_uuid(), q_id, '教授による講義内容をノートに記録すること', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '現在の暗号技術が複雑すぎて運用や管理が困難になっているから', FALSE, 1),
    (gen_random_uuid(), q_id, '量子コンピュータにより現在の暗号が破られる可能性があるから', TRUE, 2),
    (gen_random_uuid(), q_id, '暗号化に必要な計算コストを今後大幅に削減する必要があるから', FALSE, 3),
    (gen_random_uuid(), q_id, '通信速度を向上させるために軽量な暗号方式が求められるから', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '開発環境のパフォーマンスが著しく低い', FALSE, 1),
    (gen_random_uuid(), q_id, '開発者が本番環境に直接アクセスできる', TRUE, 2),
    (gen_random_uuid(), q_id, '定期的なバックアップの仕組みが整っていない', FALSE, 3),
    (gen_random_uuid(), q_id, '操作の監査ログが十分に記録されていない', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '相手の文化を尊重し空気を読むこと', FALSE, 1),
    (gen_random_uuid(), q_id, '暗黙の前提を言語化すること', TRUE, 2),
    (gen_random_uuid(), q_id, '厳格なルールを設けて全員に従わせる', FALSE, 3),
    (gen_random_uuid(), q_id, '全ての決定を上司が一元的に行うこと', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '技術的慣性による変革の困難さという課題', FALSE, 1),
    (gen_random_uuid(), q_id, 'バリュー・センシティブ・デザイン', TRUE, 2),
    (gen_random_uuid(), q_id, '技術中立性という思想的な立場の重要性', FALSE, 3),
    (gen_random_uuid(), q_id, '技術決定論に基づいた開発手法の活用', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '技術革新を促進するため全ての規制を廃止する', FALSE, 1),
    (gen_random_uuid(), q_id, '新技術の実証実験を規制の例外として認める', TRUE, 2),
    (gen_random_uuid(), q_id, '新技術を開発する企業に対して補助金を支給する', FALSE, 3),
    (gen_random_uuid(), q_id, '技術発展を優先し消費者保護の義務を緩和する', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '社内Wikiの活用促進', FALSE, 1),
    (gen_random_uuid(), q_id, '月1回テックトークの開催', TRUE, 2),
    (gen_random_uuid(), q_id, 'ペアプログラミングの推進', FALSE, 3),
    (gen_random_uuid(), q_id, '外部研修への参加奨励', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'インターネット通信の速度が遅く情報格差が広がる', FALSE, 1),
    (gen_random_uuid(), q_id, 'デジタルリテラシーの格差が新たな不平等を生む', TRUE, 2),
    (gen_random_uuid(), q_id, 'デジタル化が進むことで選挙の投票率が低下する', FALSE, 3),
    (gen_random_uuid(), q_id, 'AIの発達により政治家の役割が完全に不要になる', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '基本給の金額差のみが対象になる', FALSE, 1),
    (gen_random_uuid(), q_id, '基本給、手当、福利厚生の全て', TRUE, 2),
    (gen_random_uuid(), q_id, '賞与の支給額の差だけが対象', FALSE, 3),
    (gen_random_uuid(), q_id, '正社員の待遇改善のみが対象', FALSE, 4);
END $$;
...
BEGIN
  ...
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, 'サービス改善のためにできるだけ多くのデータを収集する', FALSE, 1),
    (gen_random_uuid(), q_id, '最小限のデータだけを収集するデータミニマイゼーション', TRUE, 2),
    (gen_random_uuid(), q_id, 'プライバシーリスクを回避するためデータ収集自体をしない', FALSE, 3),
    (gen_random_uuid(), q_id, 'データを匿名化さえすれば収集範囲に制限は必要ない', FALSE, 4);
END $$;
