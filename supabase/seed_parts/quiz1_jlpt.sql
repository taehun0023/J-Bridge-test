...
-- Difficulty per category: easy 20%, medium 20%, hard 60%
...
VALUES ('a0000001-0000-0000-0000-000000000001', 'JLPT 日本語能力評価', 'jlpt', 70, 70, TRUE);

-- ============================================
-- GRAMMAR: easy (12 questions) sort_order 1-12
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    '「（　）」に入る正しい助詞はどれですか？\n私は毎朝コーヒー（　）飲みます。',
    '「を」は目的語を示す助詞です。「コーヒーを飲む」が正しい表現です。(커피를 마시다)', 1, 1, 'easy', 'grammar');
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    '「食べる」の丁寧形（ます形）はどれですか？',
    '「食べる」は一段動詞で、「る」を取って「ます」をつけます。(먹다 → 먹습니다)', 1, 2, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「静か」はナ形容詞で、「静かです」の形になります。(이 방은 조용합니다)', 1, 3, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「どこ」は場所を尋ねる疑問詞です。(어디에서 왔습니까?)', 1, 4, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    '「書く」のて形はどれですか？',
    '「書く」はカ行五段動詞で、て形は「書いて」になります。(쓰다의 て형)', 1, 5, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「話せます」は「話す」の可能形で、「日本語が話せる」は能力を表します。(일본어를 할 수 있습니다)', 1, 6, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    '「机の上に本が（　）。」正しいものはどれですか？',
    '物の存在には「あります」を使います。人や動物には「います」を使います。(책상 위에 책이 있습니다)', 1, 7, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「食べましょう」は意志・勧誘を表す丁寧な表現です。(같이 점심을 먹읍시다)', 1, 8, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '果物などの丸いものは「〜つ」で数えます。「三つ」が正解です。(사과를 세 개 주세요)', 1, 9, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「降ったら」は条件を表すタラ形です。(비가 오면 시합은 중지입니다)', 1, 10, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    '「昨日、映画を（　）。」正しい過去形はどれですか？',
    '「見ました」は「見る」の丁寧な過去形です。(어제 영화를 봤습니다)', 1, 11, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    '「友達が私に本を（　）。」正しいものはどれですか？',
    '「くれました」は相手が自分に何かをしてくれる時に使います。(친구가 나에게 책을 줬습니다)', 1, 12, 'easy', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- GRAMMAR: medium (12 questions) sort_order 13-24
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「踏まれた」は「踏む」の受身形です。迷惑の受身を表します。(전철 안에서 발을 밟혔다)', 1, 13, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「書かせた」は「書く」の使役形です。(선생님은 학생에게 작문을 쓰게 했다)', 1, 14, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「かもしれない」は不確実な推量を表します。(비가 올지도 모른다)', 1, 15, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「そうだ」（伝聞）は他から聞いた情報を伝える表現です。(일기예보에 따르면 내일은 맑다고 한다)', 1, 16, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「ために」は目的を表す表現です。意志動詞の辞書形に接続します。(일본어를 공부하기 위해 일본에 왔습니다)', 1, 17, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「おいしそうだ」はイ形容詞の語幹＋そうだで、見た目からの判断を表します。(이 케이크는 맛있어 보인다)', 1, 18, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「なければならない」は義務・必要を表す文型です。(내일까지 리포트를 내야 한다)', 1, 19, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「ことがある」は過去の経験を表す文型です。(후지산에 올라간 적이 있습니까?)', 1, 20, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「ながら」は二つの動作を同時に行うことを表します。(음악을 들으면서 공부하고 있습니다)', 1, 21, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「いけません」は禁止を表す丁寧な表現です。(여기서 사진을 찍으면 안 됩니다)', 1, 22, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「てみる」は試しに何かをすることを表します。(새 레스토랑에 가 보았다)', 1, 23, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「なりました」はナ形容詞＋になるで、状態の変化を表します。(일본어가 잘 하게 되었습니다)', 1, 24, 'medium', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- GRAMMAR: hard part 1 (18 questions) sort_order 25-42
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「にもかかわらず」は強い逆接を表すN2文型です。(몇 번 설명했음에도 불구하고 그는 이해하지 못했다)', 1, 25, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「傾向がある」は「〜する傾向がある」の形で傾向を表します。(최근 젊은이들은 책을 읽지 않는 경향이 있다)', 1, 26, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「に基づいて」は根拠・基準を表すN2文型です。(조사 결과에 기초하여 새로운 방침을 결정했다)', 1, 27, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「ない限り」は「〜しない限り」で必要条件を表します。(노력하지 않는 한 성공은 없다)', 1, 28, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「通り」は「予想通り」で期待に沿った結果を表します。(예상대로 프로젝트는 예정대로 완성되었다)', 1, 29, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「につれて」は二つの事柄が比例して変化することを表します。(경험을 쌓을수록 업무 효율이 올랐다)', 1, 30, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「のみならず」は「だけでなく」の硬い書き言葉です。N1文型。(그는 영어뿐만 아니라 프랑스어도 할 수 있다)', 1, 31, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「いられない」は「〜せずにはいられない」で我慢できないことを表すN1文型です。(그 영화를 보면 감동하지 않을 수 없다)', 1, 32, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「かどうか」は不確定なことについて確認する表現です。(참가할지 안 할지 내일까지 연락해 주세요)', 1, 33, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「だけに」は原因・理由を強調する表現です。(이 버그는 재현성이 낮은 만큼 수정이 어렵다)', 1, 34, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「や否や」は動作の直後を表すN1の硬い書き言葉です。(회의가 끝나자마자 바로 보고서를 작성했다)', 1, 35, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「に関して」は「について」のフォーマルな表現です。(보안 대책에 관하여 전 사원에게 통지했다)', 1, 36, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「見間違える」＋ほどで、日本人と間違うほど上手だという意味です。(그의 일본어 실력은 일본인과 헷갈릴 정도다)', 1, 37, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「途中」は進行中の過程を表す名詞です。(개발 도중에 문제가 발생했다)', 1, 38, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「言うまでもなく」は「当然のこととして」の意味のN1表現です。(품질관리는 말할 것도 없고 납기 엄수도 요구된다)', 1, 39, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「したとしても」は仮定の譲歩を表す表現です。(설령 실패하더라도 도전하는 것에 의미가 있다)', 1, 40, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「には」＋「いたしかねます」は丁寧な断り表現です。(고객님의 요망에는 대응하기 어렵습니다)', 1, 41, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「次第」は「結果次第」で条件・依存を表します。(결과에 따라서는 계획을 변경할 필요가 있다)', 1, 42, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- GRAMMAR: hard part 2 (18 questions) sort_order 43-60
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「につきまして」は「について」の敬語表現で、ビジネス文書でよく使われます。(본건에 대하여 아래와 같이 보고드립니다)', 1, 43, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「によると」は情報源を示す表現です。(그의 이야기에 의하면 프로젝트는 순조로운 것 같다)', 1, 44, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「よりほかない」は「他に方法がない」の意味のN1文型です。(납기에 맞추기 위해서는 야근할 수밖에 없다)', 1, 45, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「べく」は「〜するために」の書き言葉的表現です。(데이터를 보호하고자 암호화를 구현했다)', 1, 46, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「にあたって」は重要な行動の前に使う表現です。(시스템을 도입함에 있어서 충분한 테스트가 필요하다)', 1, 47, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「末（に）」は長い過程の結果を表すN2文型です。(오랜 시간 논의한 끝에 최종적으로 합의에 도달했다)', 1, 48, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「言うに及ばない」は「言う必要がないほど明らか」という意味のN1表現です。(정보 유출의 위험성은 말할 나위도 없다)', 1, 49, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「一方で」は二つの事柄を対比する表現です。(프론트엔드는 개선된 한편 백엔드에는 과제가 남아 있다)', 1, 50, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「んばかりに」は「今にも〜しそうな様子で」の意味のN1文型です。(그녀는 울기라도 할 것처럼 감사의 말을 전했다)', 1, 51, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「を問わず」は条件に関係なくという意味です。(경험 유무에 관계없이 응모할 수 있습니다)', 1, 52, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「あえて」は困難やリスクを知りながらも意図的に行動することを表します。(리스크를 알면서도 일부러 새로운 기술을 채용했다)', 1, 53, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「にしては」は基準と比べて意外だという評価を表します。(입사 1년차치고는 그의 스킬은 매우 높다)', 1, 54, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「得る」の否定形「得ない」は可能性の否定を表します。「できるものではない」の強調形です。(이 문제는 간단히 해결될 수 있는 것이 아니다)', 1, 55, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「かわりに」はマイナス面とプラス面の代償関係を表します。(야근이 많은 대신 급료는 좋다)', 1, 56, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「なりました」は「お〜になる」の尊敬語パターンです。(부장님이 먼저 돌아가셨습니다)', 1, 57, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「お持ちいたします」は「持つ」の謙譲語です。(자료는 제가 가져가겠습니다)', 1, 58, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「必ずしも」は部分否定の副詞で、「〜とは限らない」と共に使われます。(비싼 소프트웨어가 반드시 좋다고는 할 수 없다)', 1, 59, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '「かのように」は事実と異なる比喩を表すN1文型です。(그는 아무 일도 없었던 것처럼 태연하게 있었다)', 1, 60, 'hard', 'grammar');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- READING: easy (6 questions) sort_order 61-66
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '簡単な社内お知らせの読解です。清掃の日程と準備物について書かれています。(사내 청소의 날에 관한 공지입니다)', 1, 61, 'easy', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'ビジネスメールの読解です。打ち合わせの時間変更の確認をお願いしています。(회의 시간 변경 확인을 부탁하고 있습니다)', 1, 62, 'easy', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '日常生活の文章の読解です。「8時半ごろに着きます」が答えです。(이 사람은 8시 반쯤 회사에 도착합니다)', 1, 63, 'easy', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '営業時間の案内の読解です。土曜日は18時までです。(토요일은 18시까지 영업합니다)', 1, 64, 'easy', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '天気予報の読解です。明日は晴れるが気温が下がります。(내일은 맑지만 기온이 내려갑니다)', 1, 65, 'easy', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '食堂メニューの読解です。C定食（野菜）が450円で最も安いです。(C정식(야채)이 450엔으로 가장 저렴합니다)', 1, 66, 'easy', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- READING: medium (6 questions) sort_order 67-72
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '有給休暇の手続きに関する文章です。急病の場合は当日朝までに電話連絡が必要です。(갑자기 아프면 당일 아침까지 전화로 연락해야 합니다)', 1, 67, 'medium', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'レビュー文の読解です。「画面が少し小さい」が欠点として述べられています。(화면이 조금 작다는 것이 단점입니다)', 1, 68, 'medium', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '社内通知の読解です。パスワードをメモに書いて貼ったり、社外の人に教えたりしてはいけません。(비밀번호를 메모에 적어 붙이거나 외부인에게 알려주면 안 됩니다)', 1, 69, 'medium', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '新入社員研修の案内の読解です。第2週は各部署での実習です。(2주차에는 각 부서에서 실습을 합니다)', 1, 70, 'medium', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '在宅勤務に関する意見文の読解です。ハイブリッド型は在宅とオフィス勤務を組み合わせた方式です。(하이브리드형은 재택과 사무실 출근을 조합한 방식입니다)', 1, 71, 'medium', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '勉強会のお知らせの読解です。参加方法に関係なく、Slackで申し込む必要があります。(온라인 참가도 Slack에서 신청해야 합니다)', 1, 72, 'medium', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- READING: hard part 1 (9 questions) sort_order 73-81
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'IT プロジェクト報告書の読解です。独自の移行ツールを開発して自動化しました。(독자적인 마이그레이션 도구를 개발하여 자동화했습니다)', 1, 73, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '日本のIT業界の構造問題に関する文章です。段階的な改革が必要だと述べています。(단계적인 개혁이 필요하다고 서술하고 있습니다)', 1, 74, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'マイクロサービスの通信方法に関する技術文書の読解です。非同期通信はリアルタイム性が損なわれます。(비동기 통신은 실시간성이 저하됩니다)', 1, 75, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '個人情報保護に関する法律文書の読解です。漏洩時は本人と委員会への報告義務があります。(유출 시 본인과 위원회에 보고할 의무가 있습니다)', 1, 76, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'AI に関する論説文の読解です。AIと共存する方法を考えることが重要だと主張しています。(AI와 공존하는 방법을 모색하는 것이 중요하다고 주장하고 있습니다)', 1, 77, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '会議の議事録の読解です。次回までにGo移行のコストと工数を調査します。(다음 회의까지 Go 이전의 비용과 공수를 조사합니다)', 1, 78, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '技術的負債に関する論考文です。完全排除ではなく許容範囲内での管理が重要だと主張しています。(완전 배제가 아닌 허용 범위 내 관리가 중요하다고 주장합니다)', 1, 79, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '契約書の読解です。再委託には委託者の書面による事前承諾が必要です。(재위탁에는 위탁자의 서면에 의한 사전 승인이 필요합니다)', 1, 80, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'コードレビュー施策の評価文書の読解です。AI自動レビュー導入で品質と速度を両立する方針です。(AI 자동 리뷰 도입으로 품질과 속도를 양립하는 방침입니다)', 1, 81, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- READING: hard part 2 (9 questions) sort_order 82-90
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'セキュリティと利便性のバランスについての文章です。両者の最適なバランスが重要です。(보안과 편의성의 최적 균형이 중요합니다)', 1, 82, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'アジャイル開発に関する文章です。変化に対応するために計画と見直しが重要だと述べています。(변화에 대응하기 위해 계획과 검토가 중요하다고 강조합니다)', 1, 83, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '人材育成方針に関する文書の読解です。OJTが基盤です。(OJT가 기반입니다)', 1, 84, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'CI/CDに関する技術文書の読解です。構築と維持に工数がかかることが課題です。(구축과 유지에 공수가 드는 것이 과제입니다)', 1, 85, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '報連相の文化に関する文章です。チーム全体でリスクを早期発見・対処するためです。(팀 전체로 리스크를 조기 발견·대처하기 위함입니다)', 1, 86, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'データベース設計に関する技術文書の読解です。パフォーマンス向上が主な理由です。(퍼포먼스 향상이 주된 이유입니다)', 1, 87, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'ポストモーテムに関する文章です。個人を責めずプロセスを分析する文化が必要です。(개인을 비난하지 않고 프로세스를 분석하는 문화가 필요합니다)', 1, 88, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'REST API設計に関する技術文書です。URL変更によりクライアント修正が必要になります。(URL 변경으로 클라이언트 수정이 필요해집니다)', 1, 89, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '属人化と知識共有に関する文章です。ドキュメントとペアプロで知識共有を促進することが解決策です。(문서화와 페어프로그래밍으로 지식 공유를 촉진하는 것이 해결책입니다)', 1, 90, 'hard', 'reading');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- LISTENING: easy (6 questions) sort_order 91-96
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '自己紹介の会話です。キムさんは「韓国から来ました」と言っています。(김씨는 한국에서 왔습니다)', 1, 91, 'easy', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '道案内の会話です。「二つ目の信号を右に曲がる」が正解です。(두 번째 신호에서 우회전합니다)', 1, 92, 'easy', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '飲食店での注文の会話です。ホットコーヒーを注文しました。(핫 커피를 주문했습니다)', 1, 93, 'easy', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'スケジュール確認の会話です。会議は10時からです。(회의는 10시부터입니다)', 1, 94, 'easy', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '電話応対の会話です。山田さんは外出中です。(야마다 씨는 외출 중입니다)', 1, 95, 'easy', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '天気の会話です。「暑い」「30度以上」と言っているので暑い天気です。(오늘은 더운 날씨입니다)', 1, 96, 'easy', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- LISTENING: medium (6 questions) sort_order 97-102
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '業務の進捗確認の会話です。データベースの設計に時間がかかっています。(데이터베이스 설계에 시간이 걸리고 있습니다)', 1, 97, 'medium', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '歓迎会の準備に関する会話です。駅前のイタリアンレストランです。(역 앞 이탈리안 레스토랑입니다)', 1, 98, 'medium', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'プレゼン準備の会話です。グラフのデータ更新がまだです。(그래프 데이터 업데이트가 아직입니다)', 1, 99, 'medium', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'トラブル報告の会話です。紙が詰まっていました。(종이가 걸려 있었습니다)', 1, 100, 'medium', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'スケジュール変更の会話です。水曜日から木曜日に変更されました。(수요일에서 목요일로 변경되었습니다)', 1, 101, 'medium', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '昼食の相談の会話です。定食屋に行くことになりました。(정식집에 가기로 했습니다)', 1, 102, 'medium', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- LISTENING: hard part 1 (9 questions) sort_order 103-111
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'スプリント振り返りの会話です。バッファを設けてポイントを減らす計画です。(버퍼를 두고 포인트를 줄여 계획합니다)', 1, 103, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'コードレビューの会話です。一つの関数に責務が多すぎることが問題です。(하나의 함수에 책임이 너무 많다는 것이 문제입니다)', 1, 104, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'クライアントとの商談の会話です。100万円の2割引で80万円です。(100만엔의 20% 할인으로 80만엔입니다)', 1, 105, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'インシデント対応の会話です。まず影響範囲を確認するよう指示しました。(먼저 영향 범위를 확인하도록 지시했습니다)', 1, 106, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '評価面談の会話です。チームミーティングでの発言を増やすよう求めています。(팀 미팅에서의 발언을 늘리도록 요구하고 있습니다)', 1, 107, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'アーキテクチャ議論の会話です。まずモジュラーモノリスにして段階的に移行する提案です。(먼저 모듈러 모노리스로 하고 단계적으로 이전하는 제안입니다)', 1, 108, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '人事に関する会話です。早いうちからリーダーシップ経験を積ませるためです。(일찍부터 리더십 경험을 쌓게 하기 위해서입니다)', 1, 109, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'デプロイ戦略の会話です。大きな仕様変更があり、即座にロールバックできる方が安全だからです。(큰 사양 변경이 있어 즉시 롤백할 수 있는 것이 안전하기 때문입니다)', 1, 110, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'メンタリングの会話です。問題発生時に早めに相談することの重要性を強調しています。(문제 발생 시 빨리 상담하는 것의 중요성을 강조하고 있습니다)', 1, 111, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
...
-- ============================================
-- LISTENING: hard part 2 (9 questions) sort_order 112-120
-- ============================================
DO $$
DECLARE q_id UUID;
BEGIN
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '要件変更に関する会話です。影響範囲を整理して見積もりを出した上でお客様と協議します。(영향 범위를 정리하고 견적을 낸 후 고객과 협의합니다)', 1, 112, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '技術研修の会話です。カーネル共有のためVMに比べて分離性が低いことがデメリットです。(커널을 공유하므로 VM에 비해 격리성이 낮은 것이 단점입니다)', 1, 113, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'チーム間の意見対立に関する会話です。外部はREST、内部はgRPCのハイブリッドアプローチです。(외부는 REST, 내부는 gRPC의 하이브리드 접근법입니다)', 1, 114, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'プロジェクト振り返りの会話です。新メンバーのキャッチアップに時間がかかりました。(새 멤버의 적응에 시간이 걸렸습니다)', 1, 115, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '見積もり会議の会話です。テスト期間は品質のために削れないと主張しています。(테스트 기간은 품질을 위해 줄일 수 없다고 주장합니다)', 1, 116, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'ビジネスマナーの会話です。名刺は打ち合わせ中テーブルの上に置いておきます。(명함은 미팅 중 테이블 위에 놓아둡니다)', 1, 117, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'セキュリティブリーフィングの会話です。取引先を装い添付ファイルを開かせるのが主な手口です。(거래처를 사칭하여 첨부파일을 열게 하는 것이 주된 수법입니다)', 1, 118, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    'チームビルディングの会話です。デモタイムで成果を可視化してモチベーションを上げる提案です。(데모 타임으로 성과를 가시화하여 동기부여를 높이는 제안입니다)', 1, 119, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
  ...
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice',
    ...
    '日本のビジネスコミュニケーションの会話です。「検討します」は婉曲な断りの場合もあります。(「검토하겠습니다」는 완곡한 거절인 경우도 있습니다)', 1, 120, 'hard', 'listening');
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
