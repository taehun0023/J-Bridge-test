...
BEGIN
  ...
  q_id := gen_random_uuid();
  INSERT INTO quiz_questions (id, quiz_id, question_type, question_text, explanation, points, sort_order, difficulty, question_category)
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice', '次の文を読んで正しいものを選んでください。\n「台風の接近に伴い、明日の午後から交通機関が運休する可能性があります。不要不急の外出はお控えください。」\nこの文の内容として正しいものは？', '台風接近→交通機関の運休可能性→外出を控えるよう呼びかけている文章です。', 1, 53, 'medium', NULL);
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '태풍이 지나가서 교통이 정상 운행된다', FALSE, 1),
    (gen_random_uuid(), q_id, '내일 오전부터 교통기관이 운휴할 예정이다', FALSE, 2),
    (gen_random_uuid(), q_id, '태풍 접근으로 교통기관이 운휴할 수 있어 외출을 삼가라고 한다', TRUE, 3),
    (gen_random_uuid(), q_id, '태풍과 관계없이 평소대로 외출해도 된다', FALSE, 4);
  ...
  q_id := gen_random_uuid();
  INSERT INTO quiz_questions (id, quiz_id, question_type, question_text, explanation, points, sort_order, difficulty, question_category)
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice', '次の文を読んで正しいものを選んでください。\n「高齢社会の進展に伴い、退職後の人生をいかに充実させるかが重要な課題となっている。生涯学習は単なる知識の習得にとどまらず、高齢者にとっての生きがいや社会参加の機会を提供するものであり、孤立防止の観点からもその意義は計り知れない。」\n筆者の主張として最も適切なものは？', '高齢社会における生涯学習の重要性と社会参加について述べた文章です。', 1, 68, 'hard', NULL);
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '고령자는 은퇴 후 충분히 쉬는 것이 가장 중요하다', FALSE, 1),
    (gen_random_uuid(), q_id, '생애학습은 고령자에게 보람과 사회 참여 기회를 제공하며 고립 방지에도 큰 의의가 있다', TRUE, 2),
    (gen_random_uuid(), q_id, '생애학습은 단순한 지식 습득이므로 고령자에게는 적합하지 않다', FALSE, 3),
    (gen_random_uuid(), q_id, '고령 사회에서 은퇴 후의 생활은 개인의 문제이므로 사회적 논의가 필요 없다', FALSE, 4);
  ...
  q_id := gen_random_uuid();
  INSERT INTO quiz_questions (id, quiz_id, question_type, question_text, explanation, points, sort_order, difficulty, question_category)
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice', '次の文を読んで正しいものを選んでください。\n「日本語には曖昧な表現が多く、非母語話者にとってはコミュニケーション上の齟齬を生む要因となり得る。例えば、『結構です』は肯定と否定の両方の意味を持ち、『考えておきます』は前向きな検討ではなく婉曲な拒否として用いられることが少なくない。こうした表現の真意を読み取るには、文脈や話者の語調を総合的に判断する力が不可欠である。」\nこの文の主旨は？', '日本語の曖昧表現が非母語話者にとってコミュニケーション上の齟齬を生む問題について述べた文章です。', 1, 76, 'hard', NULL);
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '일본어의 애매한 표현은 일본인끼리도 자주 오해를 일으킨다', FALSE, 1),
    (gen_random_uuid(), q_id, '애매한 표현의 진의를 파악하려면 문맥과 화자의 어조를 종합적으로 판단하는 능력이 필요하다', TRUE, 2),
    (gen_random_uuid(), q_id, '「結構です」는 항상 긍정적인 의미로만 사용된다', FALSE, 3),
    (gen_random_uuid(), q_id, '「考えておきます」는 적극적으로 검토하겠다는 의미이다', FALSE, 4);
  ...
  q_id := gen_random_uuid();
  INSERT INTO quiz_questions (id, quiz_id, question_type, question_text, explanation, points, sort_order, difficulty, question_category)
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice', '次の文を読んで正しいものを選んでください。\n「伝統工芸の存続が危ぶまれる中、現代の技術や感覚を取り入れた革新を試みる職人が増えている。しかしながら、伝統の本質を損なうような安易な現代化は、かえって文化的価値を毀損しかねない。伝統を守りつつも時代に即した変化を受け入れるという、微妙な均衡を保つことが求められている。」\nこの文の要旨は？', '伝統文化の保存と現代化のバランスについて述べた文章です。', 1, 86, 'hard', NULL);
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '전통 공예는 시대에 뒤떨어졌으므로 전면적으로 현대화해야 한다', FALSE, 1),
    (gen_random_uuid(), q_id, '전통 공예는 원래의 형태를 절대적으로 지켜야 하며 변화를 허용해서는 안 된다', FALSE, 2),
    (gen_random_uuid(), q_id, '현대 기술을 도입하면 전통 공예의 가치가 반드시 높아진다', FALSE, 3),
    (gen_random_uuid(), q_id, '전통의 본질을 지키면서도 시대에 맞는 변화를 받아들이는 미묘한 균형이 필요하다', TRUE, 4);
  ...
  q_id := gen_random_uuid();
  INSERT INTO quiz_questions (id, quiz_id, question_type, question_text, explanation, points, sort_order, difficulty, question_category)
  VALUES (q_id, 'a0000001-0000-0000-0000-000000000001', 'multiple_choice', '次の文を読んで正しいものを選んでください。\n「ポイントカードやキャッシュレス決済の普及により、消費者の購買履歴や行動パターンが詳細に記録される時代となった。こうしたデータの蓄積は、個人に最適化されたサービスの提供を可能にする一方で、個人情報の漏洩や不正利用といったリスクも孕んでいる。日常の利便性を享受しつつ、自らの情報をいかに守るかという意識が、現代の消費者には求められている。」\nこの文の主旨は？', '日常生活における個人情報保護と利便性のバランスについて消費者の視点で述べた文章です。', 1, 90, 'hard', NULL);
  INSERT INTO quiz_question_options (id, question_id, option_text, is_correct, sort_order) VALUES
    (gen_random_uuid(), q_id, '개인정보 보호를 위해 포인트 카드와 캐시리스 결제를 사용하지 않아야 한다', FALSE, 1),
    (gen_random_uuid(), q_id, '편의성이 가장 중요하므로 개인정보 수집은 신경 쓸 필요가 없다', FALSE, 2),
    (gen_random_uuid(), q_id, '일상의 편리함을 누리면서도 자신의 정보를 어떻게 지킬지 의식하는 것이 현대 소비자에게 요구된다', TRUE, 3),
    (gen_random_uuid(), q_id, '개인정보 유출 위험은 기업만의 책임이므로 소비자가 걱정할 문제가 아니다', FALSE, 4);
