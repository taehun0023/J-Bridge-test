...
const quickLinks = [
  ...
  { href: '/admin/mentors', label: 'メンター管理', desc: 'メンター割り当て・専門設定', icon: UserCog },
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card title="通知">
          <div className="flex flex-col items-center justify-center py-4">
            <Bell className={`h-8 w-8 ${unreadNotifications > 0 ? 'text-amber-500' : 'text-gray-400 dark:text-gray-600'}`} />
            <p className="mt-2 text-2xl font-bold text-gray-900 dark:text-white">{unreadNotifications}</p>
