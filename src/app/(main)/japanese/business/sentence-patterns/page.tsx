...
const QUIZ_TYPE = 'sentence_pattern'
const DB_CATEGORY = 'sentence_pattern'
...
export default async function SentencePatternsPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">文型</h1>
        <p className="mt-1 text-gray-500 dark:text-gray-400">依頼・報告・応答の文型を学習しましょう</p>
      </div>
