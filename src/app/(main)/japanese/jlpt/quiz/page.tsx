...
export default async function QuizListPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">JLPT学習クイズ</h1>
        <p className="mt-1 text-gray-500 dark:text-gray-400">級別のクイズを解いて実力を確認しましょう</p>
      </div>
      ...
      {!hasAny ? (
        ...
        <div className="space-y-8">
          {vocabQuizzes.length > 0 && (
            <div>
              <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">語彙クイズ</h2>
          ...
          {grammarQuizzes.length > 0 && (
            <div>
              <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">文法クイズ</h2>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {readingQuizzes.length > 0 && (
            <div>
              <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">読解クイズ</h2>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {listeningQuizzes.length > 0 && (
            <div>
              <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">聴解クイズ</h2>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
