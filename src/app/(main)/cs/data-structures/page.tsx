...
const CATEGORY = 'data_structures'

export default async function DataStructuresPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">データ構造</h1>
        <p className="mt-1 text-gray-500 dark:text-gray-400">配列、リスト、スタック、キュー、ツリー、ハッシュを学習しましょう</p>
      </div>
