...
const CATEGORY = 'computer_architecture'

export default async function ComputerArchitecturePage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">コンピュータシステム</h1>
        <p className="mt-1 text-gray-500 dark:text-gray-400">CPU、メモリ、プロセス、OS機能を学習しましょう</p>
      </div>
      ...
      <CsGlossaryClient
        ...
        totalCount={count ?? 0}
        basePath="/cs/computer-architecture"
        offset={offset}
        masteredIds={masteredIds}
        mastery={mastery}
        categoryLabel="コンピュータシステム"
      />
    </div>
  )
}
