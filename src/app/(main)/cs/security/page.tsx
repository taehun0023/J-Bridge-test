...
export default async function SecurityPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">セキュリティ</h1>
        <p className="mt-1 text-gray-500 dark:text-gray-400">暗号化、認証、攻撃手法、セキュリティ対策を学習しましょう</p>
      </div>
