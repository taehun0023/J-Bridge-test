...
export default async function LessonQuizPage({ params }: { params: Promise<Params> }) {
  const { id: courseId, lessonId, quizId } = await params
  ...
  return (
    <QuizTaker
      ...
      backUrl={`/courses/${courseId}/lessons/${lessonId}`}
    />
  )
}
